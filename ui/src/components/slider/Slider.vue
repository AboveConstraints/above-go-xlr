...
export default {
  ...
  props: {
    ...
    inputBackgroundColour: {type: String, required: false, default: "var(--ag-surface-2)"},
    rangeBackgroundColour: {type: String, required: false, default: 'var(--ag-bg)'},
    rangeColour: { type: String, required: false, default: 'var(--ag-accent)' },
    textColour: {type: String, required: false, default: 'var(--ag-accent)' },
    labelColour: {type: String, required: false, default: 'var(--ag-text)'},
...
.sliderBox {
  ...
  background: v-bind(backgroundColour);
  border: 1px solid var(--ag-divider);
  border-bottom: 2px solid color-mix(in srgb, v-bind(rangeColour) 40%, transparent);
  border-radius: 8px;
...
.sliderBox:hover {
  border-color: color-mix(in srgb, var(--ag-accent) 30%, var(--ag-divider));
  box-shadow: 0 4px 20px rgba(0, 0, 0, 0.4),
              0 0 0 1px color-mix(in srgb, var(--ag-accent) 15%, transparent);
}
</style>
