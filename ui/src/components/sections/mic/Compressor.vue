<template>
  <ExpandoGroupContainer :title="$t('message.microphone.compressor.title')" @expando-clicked="toggleAdvanced()" :expanded="isAdvanced()" variant="toggle">
...
export default {
  ...
  methods: {
    ...
    toggleAdvanced() {
      ...
      store.getActiveDevice().settings.display.compressor = mode;
