...
export default {
  ...
  methods: {
    ...
    getBackgroundColour(disabled) {
      return (disabled) ? "var(--ag-surface-2)" : "var(--ag-surface-2)";
    },
    getInputBackgroundColour(disabled) {
      return (disabled) ? "var(--ag-surface-2)" : "var(--ag-divider)";
    },
    getSliderColour(disabled) {
      return (disabled) ? "var(--ag-accent-dim)" : "var(--ag-accent)";
    },
    getLabelColour(disabled) {
      return (disabled) ? "var(--ag-text-dim)" : "var(--ag-text)";
    },
