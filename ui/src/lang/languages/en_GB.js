    ...
    message: {
        ...
        system: {
            ...
            power: {
                ...
                shutdownDescription: "These actions will be executed when the GoXLR Above is safely shut down.",
            ...
            settings: {
                ...
                autoStartAccessibility: "Start the GoXLR Above when the user logs in",
                ...
                showTrayAccessibility: "Show the GoXLR Above icon in the system tray",
                ...
                shutdownUtility: "Shutdown GoXLR Above"
            },
            ...
            firmwareUpdate: {
                ...
                warning: "You are about to flash a new firmware version to your device.\nThe developers of the GoXLR Above are not responsible for any damage that can be caused by this process. ",
