    ...
    message: {
        ...
        system: {
            ...
            power: {
                ...
                shutdownDescription: "Эти действия будут исполнены, когда GoXLR Above безопасно отключён.",
            ...
            settings: {
                ...
                autoStartAccessibility: "Запускать GoXLR Above, когда пользователь входит в систему",
                ...
                showTrayAccessibility: "Показывать иконку GoXLR Above в системном трее",
                ...
                shutdownUtility: "Отключить GoXLR Above"
            },
